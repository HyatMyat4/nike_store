...
function AddStoriesdata() {
  ...
  const handleUpload = async () => {
    try {
      ...
      const response = await addStories(fromdata);
  ...
  return (
    <div
      className="w-[100%] 905:w-[600px] mt-[15px] h-auto bg-slate-200  dark:bg-[#1E293B] rounded-[10px] p-[15px] shadow-lg frc
      ...
      <div className="w-full h-full fcc items-start  rounded-[10px] overflow-hidden">
        <div className="w-full h-auto relative ">
          ...
          >
            ...
            <div className="text-[16px] font-medium ml-[5px] ">{Progress}%</div>
          </div>
          <div
        ...
        <div className="w-full h-auto   fcc  items-start mt-[20px]  ">
          ...
          <div className="w-full h-[50px]  text-black dark:text-white rounded-[5px]  overflow-hidden">
            <input
              type="text"
              value={title}
        ...
        <div className="w-full h-[200px] rounded-[5px] mt-[20px] overflow-hidden">
          ...
          <textarea
            ...
            placeholder="Blog..."
            className="w-full h-full text-[16px]  text-black dark:text-white font-medium resize-none outline-none p-[15px] rounded-[5px] "
          ></textarea>
        </div>
        <div
