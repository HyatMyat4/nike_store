...
export default function page() {
  ...
  const UploadData = async () => {
    ...
    const responsedata = await addShoe(formdata);
  ...
  return (
    <div className="w-full h-auto 1000:h-screen frc justify-between bg-slate-200  dark:bg-[black]">
      <div className="w-full h-auto 1000:h-screen overflow-hidden  select-none">
        ...
        <div className="w-full h-auto 1000:h-full frc justify-center  ">
          <div className="w-[100%] 1000:w-[1000px] h-auto rounded-[10px]  bg-slate-300  dark:bg-[#181818f5] shadow-lg  fcc  1000:frc justify-between p-[15px]">
            <div className="w-full 600:w-[80%] 1000:w-[49%] h-full fcc  justify-start ">
              ...
              >
                <img
                  src={` ${URL || Progress > 0 ? URL : "/product1.png"}`}
                  className={`w-full h-auto z-0 ${
                    Image && IsUpload ? "hidden" : ""
                  }`}
                />
                <div
                  className={`${
