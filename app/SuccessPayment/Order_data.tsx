...
function Order_data({ data }: Props) {
  return (
    <div
      key={data.id}
      className={` relative  bg-gradient-to-b fcc w-full hover:z-[5] 500:hover:z-[999] h-auto 500:h-[300px] rounded-[10px]  mb-[25px]    shadow-lg
 ${data.shadow}
${
    ...
    >
      <div id="italy" className="fcc select-none  text-slate-200 ">
        ...
        <div className="frc justify-center mt-[5px]">
          ...
          <div className="ml-[15px] text-[gold] frc justify-center">
            <AiOutlineStar className="text-[20px] " />
            <span className="ml-[4px]">{data.rating}+</span>
          </div>
        </div>
      </div>
      <div className=" p-[20px] 500:p-0">
        <div className=" cursor-pointer rotate-0 hover:rotate-[-12deg]  transition-all  duration-700 ease-in-out">
          <Image
            ...
            width={1920}
            height={1080}
            className="w-auto 500:w-[280px] h-auto m-auto"
          />
        </div>
      </div>
    </div>
